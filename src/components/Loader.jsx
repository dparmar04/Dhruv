...
// const Loader = ({ shouldExit = false, onComplete }) => {
//   const [index, setIndex] = useState(0);
//   const [isExiting, setIsExiting] = useState(false);
//   const [hideContent, setHideContent] = useState(false);
...
//   // When shouldExit becomes true, start exit animation
//   useEffect(() => {
//     if (shouldExit) {
//       setHideContent(true);
//       setTimeout(() => {
//         setIsExiting(true);
//         setTimeout(onComplete, 800); // wait for exit to finish
//       }, 400);
//     }
//   }, [shouldExit]);
...
const Loader = ({ onComplete }) => {
  ...
  useEffect(() => {
    ...
    const totalDuration = phrases.length * 1500
    const exitTimeout = setTimeout(() => {
      setHideContent(true);
      setTimeout(() => {
        setIsExiting(true);
        setTimeout(onComplete,); // wait for exit to finish
      }, 100);
    }, totalDuration);
